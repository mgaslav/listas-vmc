...
import { CargaPdfComponent } from './components/carga-pdf/carga-pdf.component';
import { PrevisualizacionSemanalComponent } from './components/previsualizacion-semanal/previsualizacion-semanal.component';
...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, CargaPdfComponent, PrevisualizacionSemanalComponent, AdministracionParticipantesComponent],
...
export class App implements OnInit {
  ...
  activeTab: 'planificador' | 'participantes' = 'planificador';
  ...
  async ngOnInit() {
    try {
      ...
      // Si no hay candidatos guardados en la BD de Supabase, generamos algunos datos muestra
      // para que la interfaz sea funcional y demostrativa desde el primer inicio.
  ...
  private generateMockWeeklySchedule(): SemanaAsignaciones[] {
    return [
      {
        fecha_lunes: '2026-06-15',
        asignaciones: [
          {
            tipo_asignacion: 'discurso_tesoros',
            etiqueta: 'Discurso: Tesoros de la Biblia (10 min)',
            id_participante: '',
            es_ayudante_obligatorio: false,
            filtro_aptitud: 'discurso_tesoros',
            genero_requerido: 'Hombre',
            seccion: 'tesoros'
          },
          {
            tipo_asignacion: 'lectura_biblia',
            etiqueta: 'Lectura de la Biblia (4 min)',
            id_participante: '',
            es_ayudante_obligatorio: false,
            filtro_aptitud: 'lectura_biblia',
            seccion: 'tesoros'
          },
          {
            tipo_asignacion: 'primera_conversacion',
            etiqueta: 'Primera Conversación (3 min)',
            id_participante: '',
            id_ayudante: '',
            es_ayudante_obligatorio: true,
            filtro_aptitud: 'empiece_conversaciones',
            seccion: 'maestros'
          },
          {
            tipo_asignacion: 'revisita',
            etiqueta: 'Revisita (4 min)',
            id_participante: '',
            id_ayudante: '',
            es_ayudante_obligatorio: true,
            filtro_aptitud: 'haga_revisitas',
            seccion: 'maestros'
          },
          {
            tipo_asignacion: 'conductor_estudio',
            etiqueta: 'Estudio Bíblico de la Congregación: Conductor (30 min)',
            id_participante: '',
            es_ayudante_obligatorio: false,
            filtro_aptitud: 'conductor_estudio',
            genero_requerido: 'Hombre',
            seccion: 'vida'
          },
          {
            tipo_asignacion: 'lector_estudio',
            etiqueta: 'Estudio Bíblico de la Congregación: Lector (30 min)',
            id_participante: '',
            es_ayudante_obligatorio: false,
            filtro_aptitud: 'lector_estudio',
            genero_requerido: 'Hombre',
            seccion: 'vida'
          }
        ]
      },
      {
        ...
        asignaciones: [
          ...
          {
            tipo_asignacion: 'explicar_creencias',
            etiqueta: 'Explicar Creencias (5 min)',
            id_participante: '',
            es_ayudante_obligatorio: false,
            filtro_aptitud: 'explique_creencias',
            seccion: 'maestros'
          },
          {
            tipo_asignacion: 'curso_biblico',
            etiqueta: 'Curso Bíblico (5 min)',
            id_participante: '',
            id_ayudante: '',
            es_ayudante_obligatorio: true,
            filtro_aptitud: 'haga_revisitas',
